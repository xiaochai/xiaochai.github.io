...
![图片](http://wx4.sinaimg.cn/orj360/6a1f6674ly1ffck07e3gtj20lm0g274k.jpg)
...
输入你的函数(js function):
<br/>
<input placeholder="return a = function (sita){return 1+Math.sqrt(Math.pow(4*Math.sin(4*sita),2))}" style="width:80%" id="func" />
...
document.getElementById("gen").onclick = function(){
	var func = eval(document.getElementById("func").value);
